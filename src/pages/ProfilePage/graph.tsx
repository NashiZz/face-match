                ...
                <div className="card_1">
                  ...
                  >
                    ...
                    <div style={{ display: "flex", flexDirection: "column" }}>
                      <h1 className="text-2xl font-bold" style={{ marginRight: 200 }}>{image.name}</h1>
                    ...
                    >
                      <h1 className="text-5xl mt-6 font-bold" >{image.countvote}</h1>
                      <h4 className="text-2xl mt-6 font-bold" >จำนวนโหวตทั้งหมด</h4>
                    </div>
                  </div>
                </div>
                <div
